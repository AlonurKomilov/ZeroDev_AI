...
class OpenAIAdapter(LLMAdapter):
    ...
    def __init__(self):
        ...
        if not settings.OPENAI_API_KEY or settings.OPENAI_API_KEY == "your_openai_api_key_here":
            raise ValueError("❌ OPENAI_API_KEY is not configured. Please set it in your .env file or environment variables.")
...
def get_llm_adapter(model_name: str) -> LLMAdapter:
    ...
    if model_name.lower().startswith("gpt"):
        ...
        log.error(f"No adapter found for model '{model_name}'. Defaulting to OpenAIAdapter.")
