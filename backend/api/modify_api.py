...
class ModifyRequest(BaseModel):
    ...
    prompt: str = Field(..., description="The natural language prompt describing the modification.")
...
def start_modification_job(
    *,
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to start modification job: {e}")
