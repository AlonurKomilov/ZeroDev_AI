...
@pytest.mark.unit
@pytest.mark.parametrize("model_name, expected_adapter_class_name", [
...
def test_get_llm_adapter_routing(monkeypatch, model_name, expected_adapter_class_name):
    ...
    if expected_adapter_class_name == "OpenAIAdapter":
        ...
        assert not mock_claude_class.called, "ClaudeMockAdapter should not have been instantiated"
    elif expected_adapter_class_name == "ClaudeMockAdapter":
        assert not mock_openai_class.called, "OpenAIAdapter should not have been instantiated"
        assert mock_claude_class.called, "ClaudeMockAdapter should have been instantiated"
