...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "original_prompt_hash", sqlmodel.sql.sqltypes.AutoString(), nullable=False
        ),
        sa.Column(
            "suggested_prompt", sqlmodel.sql.sqltypes.AutoString(), nullable=False
        ),
    ...
    op.create_index(
        op.f("ix_promptfeedback_original_prompt_hash"),
        "promptfeedback",
        ["original_prompt_hash"],
        unique=False,
    )
    op.create_table(
        "securityviolationpattern",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_securityviolationpattern_violation_type"),
        "securityviolationpattern",
        ["violation_type"],
        unique=True,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_securityviolationpattern_violation_type"),
        table_name="securityviolationpattern",
    )
    op.drop_table("securityviolationpattern")
    op.drop_index(
        op.f("ix_promptfeedback_original_prompt_hash"), table_name="promptfeedback"
    )
